...
urlpatterns += [
    path('lista-productos/', login_required(ListaProductos.as_view()), name='lista_productos'),
...
urlpatterns += [
    path('lista-pedidos/', login_required(ListaPedidos.as_view()), name='lista_pedidos'),
    ...
    path('lista-solicitudes/', login_required(ListaSolicitudes.as_view()), name='lista_solicitudes'),
